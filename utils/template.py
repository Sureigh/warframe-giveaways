...
# NOTE: What's the point of Holder if you can derive the values from a Member object anyway?
# No need to use class abstraction for two values
# TODO: Maybe we could reuse the parser from Sera's old bot?  
